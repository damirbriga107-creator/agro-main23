...
import { FileText, FolderOpen, Upload, CheckCircle, TrendingUp, BarChart3 } from 'lucide-react';
...
export const DocumentStats: React.FC<DocumentStatsProps> = ({ stats }) => {
  ...
  // Get top document types and categories
          ...
          <div className=\"flex items-center justify-between\">
            <div>
              ...
              <p className=\"text-2xl font-bold text-purple-900\">
                {stats.documentsByStatus.completed || 0}
              </p>
